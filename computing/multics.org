...
#+TITLE: Eclats de vers : Ordina : Multics
#+AUTHOR: chimay
...
|----------------------+-----------+-------------------------------------------------+----------------------------|
| mkfs.fat             | CLI       | crée un système de fichier fat                  | dosfstools                 |
| fsck.fat             | CLI       | verifier une partition fat                      | dosfstools                 |
|----------------------+-----------+-------------------------------------------------+----------------------------|
| mke2fs               | CLI       | crée un système de fichier extended 2, 3 ou 4   | e2fsprogs                  |
| tune2fs              | CLI       | gestion des paramètres extended fs              | e2fsprogs                  |
| fsck.ext4            | CLI       | verifier une partition ext4                     | e2fsprogs                  |
|----------------------+-----------+-------------------------------------------------+----------------------------|
| btrfs                | CLI       | btrfs                                           | btrfs-progs                |
|                      |           | btrfs snapshots dans menu grub                  | grub-btrfs                 |
...
|----------------------+-----------+-------------------------------------------------+----------------------------|
| zpool                | CLI       | piscine zfs                                     | zfs-utils                  |
| zfs                  | CLI       | zfs                                             | zfs-utils                  |
|----------------------+-----------+-------------------------------------------------+----------------------------|
...
| getfacl              | CLI       | affichage des listes d’accès d’un fichier       | acl                        |
| setfacl              | CLI       | réglage des listes d’accès d’un fichier         | acl                        |
...
| pacman-static        | CLI       | gestionnaire de paquet, libs statiques incluses | pacman-static              |
...
|                      |           | remplacement de abs                             |                            |
| expac                | CLI       | requête base de donnée pacman                   | expac                      |
...
|----------------------+-----------+-------------------------------------------------+----------------------------|
| yaourt               | CLI       | sources et compilation pour AUR / dépôts        | yaourtix                   |
...
| pacaur               | CLI       | sources et compilation pour AUR / dépôts        | aur/pacaur                 |
| pikaur               | CLI       | sources et compilation pour AUR / dépôts        | aur/pikaur                 |
| trizen               | CLI       | sources et compilation pour AUR / dépôts        | aur/trizen                 |
| rua                  | CLI       | sources et compilation pour AUR / dépôts        | aur/rua                    |
| aurutils             | CLI       | utilitaires pour AUR                            | aur/aurutils               |
|----------------------+-----------+-------------------------------------------------+----------------------------|
| pacui                | CLI       | pacman & aur                                    | github/excalibur1234/pacui |
| repoctl              | CLI       | gestion de dépôt pacman & aur                   | aur/repoctl                |
|----------------------+-----------+-------------------------------------------------+----------------------------|
...
| handlr               | CLI       | programmes par défaut                           | handlr-regex               |
...
|----------------------+-----------+-------------------------------------------------+----------------------------|
| xdg-user-dirs-update | CLI       | génère les dossiers par défault dans $HOME      | xdg-user-dirs              |
|----------------------+-----------+-------------------------------------------------+----------------------------|
...
|---------------------------+-----------+----------------------------------------+-------------------------------|
| herbstluftwm              | GUI       | gestionnaire de fenêtre                | herbstluftwm                  |
| herbstclient              | CLI       | client pour contrôler herbstluftwm     | herbstluftwm                  |
|---------------------------+-----------+----------------------------------------+-------------------------------|
...
| autokey                   |           | automatisation sous Xorg               | pip/autokey                   |
...
|                           |           | comme autre touche                     |                               |
| synergy                   |           | partage de clavier et souris           | aur/synergy                   |
|---------------------------+-----------+----------------------------------------+-------------------------------|
...
| synclient                 | CLI       | configuration souris & clavier         | xf86-input-synaptics          |
...
|                           | GUI       | menu complet pour xfce                 | xfce4-whiskermenu-plugin      |
|---------------------------+-----------+----------------------------------------+-------------------------------|
...
|              |               | fait chauffer les processeurs        |                 |
|              |               | sur pc optimus gpu                   |                 |
|--------------+---------------+--------------------------------------+-----------------|
| swapon       | CLI           | activation de swap                   | util-linux      |
|              | SRV           | service systemd pour zram            | zram-generator  |
| zramctl      | CLI           | contrôle de zram                     | util-linux      |
|--------------+---------------+--------------------------------------+-----------------|
| hdparm       | CLI           | paramètres du disque                 | hdparm          |
...
|--------------+-----------+-------------------------------------------+-----------------------|
| su           | CLI       | login dans terminal comme root            | util-linux            |
|              |           | ou autre utilisateur                      |                       |
| sux          | CLI       | su conscient de la session X Window       | aur/sux               |
...
|              |           | ou autre utilisateur                      |                       |
| pkexec       | CLI       | exécute une commande en tant que root     | polkit                |
|              |           | ou autre utilisateur                      |                       |
|--------------+-----------+-------------------------------------------+-----------------------|
...
|------------+-----------+----------------------------------------------+------------------|
| btop       | TUI       | gestionnaire de tâches                       | btop             |
| htop       | TUI       | gestionnaire de tâches                       | htop             |
| nmon       | TUI       | gestionnaire de tâches                       | nmon             |
...
|------------+-----------+----------------------------------------------+------------------|
| iostat     | CLI       | statistiques entrée / sortie                 | sysstat          |
| iotop      | CLI       | classement entrée / sortie                   | iotop            |
|------------+-----------+----------------------------------------------+------------------|
...
|----------------------+-----------+-----------------------------------------+------------------------|
| fresh                | TUI       | éditeur                                 | aur/fresh-editor-bin   |
...
|-----------+-----------+--------------------------------------+-------------------|
| ueberzug  | CLI       | ueberzug                             | ueberzugpp        |
...
|---------------+-----------+-------------------------------------------+-----------------|
| rename        | CLI       | renommage par lot                         | util-linux      |
...
| vifmimg   | LIB       | visualisation d’images dans vifm  | aur/vifmimg              |
| yazi      | TUI       | gestionnaire de fichiers vi-like  | yazi                     |
|           |           | et trois panneaux                 |                          |
| ya        | CLI       | gestionnaire de plugins pour yazi | yazi                     |
| xplr      | TUI       | gestionnaire de fichiers vi-like  | xplr                     |
|-----------+-----------+-----------------------------------+--------------------------|
...
|           |           | type midnight commander           |                          |
|-----------+-----------+-----------------------------------+--------------------------|
| thunar    | GUI       | gestionnaire de fichiers          | thunar                   |
|           | LIB       | support disques amovibles         | thunar-volman            |
|           |           | pour thunar                       |                          |
|           | LIB       | support archives pour thunar      | thunar-archive-plugin    |
|           | LIB       | support contrôle de version       | thunar-media-tags-plugin |
|           |           | pour thunar                       |                          |
|           | LIB       | support tags media pour thunar    | thunar-media-tags-plugin |
|           | LIB       | support nfs pour thunar           | gvfs-nfs                 |
|           | LIB       | support samba pour thunar         | thunar-shares-plugin     |
...
| fzy      | CLI       | recherche & complétion floue                | fzy                        |
...
|----------+-----------+---------------------------------------------+----------------------------|
| mcfly    | CLI       | recherche avancée dans l’historique         | mcfly                      |
|          |           | des commandes                               |                            |
|----------+-----------+---------------------------------------------+----------------------------|
| find     | CLI       | trouver des fichiers                        | findutils                  |
| fd       | CLI       | alternative à find, en rust                 | fd                         |
| fsearch  | GUI       | recherche de fichiers                       | aur/fsearch                |
...
| rg       | CLI       | alternative à grep/ack/ag                   | ripgrep                    |
| rga      | CLI       | ripgrep aussi dans pdf, e-book, office, etc | ripgrep-all                |
| rgr      | CLI       | remplacement basé sur ripgrep               | repgrep                    |
...
| redo     | CLI       | construction de projet               | redo-sh         |
| bmake    | CLI       | make de NetBSD                       | bmake           |
| cmake    | CLI       | construction de projet               | cmake           |
| ninja    | CLI       | construction de projet               | ninja           |
| meson    | CLI       | construction de projet               | meson           |
| yacc     | CLI       | générateur de parser                 | bison           |
...
| pdfsandwich  | CLI       | ajoute une couche de texte    | aur/pdfsandwich       |
|              |           | à un pdf contenant des images |                       |
...
|-------------+-----------+------------------------------------+-----------------|
| tmmpr       | TUI       | carte mentale                      | aur/tmmpr-bin   |
|-------------+-----------+------------------------------------+-----------------|
| xan         | CLI       | utilitaires pour csv (table avec   |                 |
|             |           | valeurs séparées par des virgules) |                 |
|-------------+-----------+------------------------------------+-----------------|
| calcurse    | TUI       | calendrier, tâches                 | calcurse        |
| sc-im       | TUI       | tableur                            | aur/sc-im-git   |
| gnuplot     | GUI       | pour graphiques dans sc-im         | gnuplot         |
| neoleo      | TUI       | tableur                            | aur/neoleo      |
...
| uv         | CLI       | gestionnaire de paquets python    | pip/uv              |
|------------+-----------+-----------------------------------+---------------------|
| ruby       | LANG      | ruby                              | ruby                |
...
|---------------------+-----------+---------------------------------------+---------------------------------|
| netctl              | CLI       | réseau                                | netctl                          |
| wifi-menu           | TUI       | réseau wifi                           | netctl                          |
| connmanctl          | CLI       | réseau                                | connman                         |
| iwctl               | CLI       | configuration wifi via iwd            | iwd                             |
|---------------------+-----------+---------------------------------------+---------------------------------|
| avahi               | SRV       | implémentation de Zero-Conf           | avahi                           |
|                     |           | permet la résolution de ordi.local    | nss-mdns                        |
|---------------------+-----------+---------------------------------------+---------------------------------|
| netcat              | CLI       | communication à travers le réseau     | openbsd-netcat                  |
| nc                  | CLI       | communication à travers le réseau     | openbsd-netcat                  |
...
|---------------------+-----------+---------------------------------------+---------------------------------|
| protonvpn           | CLI       | réseau virtuel privé de proton        | proton-vpn-cli                  |
| protonvpn-app       | GUI       | réseau virtuel privé de proton        | proton-vpn-gtk-app              |
|---------------------+-----------+---------------------------------------+---------------------------------|
...
| net                 | CLI       | administration samb#a                 | smbclient                       |
...
| torrent-tui         | TUI       | torrent                               | aur/torrent-tui                 |
|---------------------+-----------+---------------------------------------+---------------------------------|
| curl                | CLI       | téléchargement de page(s) web         | curl                            |
| wget                | CLI       | téléchargement de page(s) web         | wget                            |
| http                | CLI       | téléchargement de page(s) web         | httpie                          |
| curlie              | CLI       | téléchargement de page(s) web         | curlie                          |
...
| readable            | CLI       | filtre l’essentiel d’une page web     | aur/nodejs-readability-cli      |
| rdrview             | CLI       | filtre l’essentiel d’une page web     | aur/rdrview-git                 |
|---------------------+-----------+---------------------------------------+---------------------------------|
...
|---------------------+-----------+---------------------------------------+---------------------------------|
| tor                 | SRV       | tor                                   | tor                             |
| torify              | CLI       | route le traffic d’une application    | tor                             |
|                     |           | via tor                               |                                 |
| torsocks            | CLI       | route le traffic d’une application    | torsocks                        |
|                     |           | via tor                               |                                 |
| nyx                 | CLI       | moniteur pour tor                     | nyx                             |
|---------------------+-----------+---------------------------------------+---------------------------------|
| qutebrowser         | GUI       | navigateur web vim-like               | qutebrowser                     |
| vieb                | GUI       | navigateur web vim-like               | aur/vieb-bin                    |
| viper-browser       | GUI       | navigateur web vim-like               | am/viper-browser                |
| floorp              | GUI       | navigateur web                        | aur/floorp-bin                  |
| zen-browser         | GUI       | navigateur web                        | aur/zen-browser-bin             |
| fifo                | GUI       | navigateur web                        | aur/fifo-browser-bin            |
| helium              | GUI       | navigateur web                        | aur/helium-browser-bin          |
| palemoon            | GUI       | navigateur web                        | palemoon                        |
| mullvad-browser     | GUI       | navigateur web basé sur tor           | aur/mullvad-browser-bin         |
| torbrowser-launcher | GUI       | navigateur web basé sur tor           | torbrowser-launcher             |
...
| newsraft            | TUI       | lecteur de flux RSS                   | aur/newsraft                    |
|---------------------+-----------+---------------------------------------+---------------------------------|
...
|---------------------+-----------+---------------------------------------+---------------------------------|
| lighttpd            | SRV       | serveur web                           | lighttpd                        |
...
| dysk      | CLI       | espace libre sur le disque           | dysk            |
...
| aft-mtp-cli           | CLI       | accès android via interface type ftp    | android-file-transfer           |
...
| syncthing-gtk  | GUI       | synchronisation multidirectionnelle | aur/syncthing-gtk |
...
| rclone-browser | GUI       | gui pour rclone                     | am/rclone-browser |
|----------------+-----------+-------------------------------------+-------------------|
...
| timeshift    | CLI, GUI  | backup & récupération de système           | timeshift          |
|              |           | auto snapshot avec timeshift avant chaque  | timeshift-autosnap |
|              |           | mise à jour avec pacman                    |                    |
|              |           | backup automatique à chaque mise à jour    | timeshift-autosnap |
...
|-------------------+-----------+-------------------------------------------+-----------------|
| argon2            | CLI       | hash de mot de passe                      | argon2          |
| scrypt            | CLI       | hash de mot de passe                      | scrypt          |
|-------------------+-----------+-------------------------------------------+-----------------|
| gpg               | CLI       | clés de chiffrement                       | gnupg           |
| gpgconf           | CLI       | configuration gpg                         | gnupg           |
| gpg-connect-agent | CLI       | communication avec gpg-agent              | gnupg           |
| gpgtar            | CLI       | chiffrement répertoire                    | gnupg           |
|                   |           | déverrouillage de la clé au login         | pam-gnupg       |
| gpg-tui           | TUI       | interface pour gnupg                      | aur/gpg-tui-bin |
| libgcrypt         | LIB       | librairie de chiffrement basée sur gnupg  | libgcrypt       |
|-------------------+-----------+-------------------------------------------+-----------------|
...
| keypassxc-cli     | CLI       | gestionnaire de mots de passe             | keepassxc       |
| andcli            | TUI       | gestionnaire de mots de passe à           | aur/andcli-bin  |
|                   |           | utilisation unique                        |                 |
|-------------------+-----------+-------------------------------------------+-----------------|
...
|-------------------+-----------+-------------------------------------------+-----------------|
| cryptsetup        | CLI       | chiffrement avec LUKS (linux unified      | cryptsetup      |
|                   |           | key setup)  et dm-crypt (device mapper)   |                 |
|-------------------+-----------+-------------------------------------------+-----------------|
| age               | CLI       | chiffrement de fichier                    | age             |
| tcplay            | CLI       | implémentation truecrypt                  | tcplay          |
| veracrypt         | GUI, CLI  | variante de truecrypt                     | veracrypt       |
| tomb              | CLI       | gestion de container chiffré              | aur/tomb        |
...
|-------------------+-----------+-------------------------------------------+-----------------|
| steghide          | CLI       | cacher ou extraire information dans image | aur/steghide    |
| stegseek          | CLI       | rechercher information dans image         | aur/stegseek    |
|-------------------+-----------+-------------------------------------------+-----------------|
...
| calligra              | GUI       | bureautique                           |                             |
| abiword               | GUI       | traitement de texte                   |                             |
| gnumeric              | GUI       | tableur                               |                             |
...
| chafa        | GUi       | visualisateur d’image dans un terminal | chafa                     |
...
|              |           | compatibilité pulse                    |                           |
|              | SRV       | pipewire, compatibilité alsa           | pipewire-alsa             |
| pw-record    | CLI       | enregistrement                         | pipewire                  |
| wpctl        | CLI       | cli pour wireplumber                   | wireplumber               |
...
|--------------+-----------+----------------------------------------+---------------------------|
| rvlc         | CLI       | lecteur audio & vidéo, dummy           | vlc-cli                   |
| cvlc         | CLI       | lecteur audio & vidéo, cli, à distance | vlc-cli                   |
| nvlc         | TUI       | lecteur audio & vidéo                  | vlc-gui-ncurses           |
| vlc          | GUI       | lecteur audio & vidéo                  | vlc                       |
|              | PLUG      | tous les plugins pour vlc              | vlc-plugins-all           |
...
| freetube     | GUI       | navigateur youtube                     | am/freetube               |
| ytfzf        | CLI       | lecture de vidéo yt                    | ytfzf                     |
|--------------+-----------+----------------------------------------+---------------------------|
| lsdvd        | CLI       | liste le contenu d’un DVD              | lsdvd                     |
|              | LIB       | lecture dvd                            | libdvdread                |
|              | LIB       | navigation dvd                         | libdvdnav                 |
|              | LIB       |                                        | libdvdcss                 |
|--------------+-----------+----------------------------------------+---------------------------|
...
| cwebp          | CLI       | conversion -> webp                                | libwebp-utils        |
...
| converseen     | GUI       | boîte à outils images                             |                      |
| xnviewmp       | GUI       | édition d’images                                  | am/xnviewmp          |
|----------------+-----------+---------------------------------------------------+----------------------|
| pico-tts       | CLI       | texte -> audio                                    | aur/pico-tts         |
| pico2wave      | CLI       | texte -> audio                                    | aur/pico2wave-shell  |
|----------------+-----------+---------------------------------------------------+----------------------|
...
|            | CLI       | tous les pacquet TeX                    | group : texlive-meta     |
...
|            |           | remplacement unicode pour bibtex        | biber                    |
...
|-----------------+-----------+------------------------------------+-----------------------|
| update-ca-trust | CLI       | certificats                        | ca-certificates-utils |
|                 | LIB       | qute pass                          | pip/tldextract        |
|                 |           |                                    | python-tldextract     |
|-----------------+-----------+------------------------------------+-----------------------|
...
|--------------+-----------+------------------------------------------+-------------------------|
|              | SRV       | gestion de services utilisateurs         | turnstile-dinit         |
|              |           | avec dinit                               |                         |
|--------------+-----------+------------------------------------------+-------------------------|
| artix-chroot | CLI       | chroot dans un système artix             | artools-base            |
| basetrap     | CLI       | installe des paquets dans un répertoire  | artools-base            |
|              |           | racine autre que /                       |                         |
| fstabgen     | CLI       | génère un fstab                          | artools-base            |
|--------------+-----------+------------------------------------------+-------------------------|
| yaourtix     | CLI       | sources et compilation pour AUR / dépôts | yaourtix                |
...
|              |           | un fichier                               |                 |
| xmirror      | CLI       | changement du miroir pour xbps           | xmirror         |
...
| Commande      | Interface | Fonction                      | Paquet ou dépôt |
|---------------+-----------+-------------------------------+-----------------|
| neovim        | TUI       | éditeur                       | neovim          |
| nvim-qt       | GUI       | qt gui pour neovim            | neovim-qt       |
| neovim-remote | TUI       | contrôle à distance de neovim | neovim          |
|---------------+-----------+-------------------------------+-----------------|
| emacs         | GUI       | éditeur                       | emacs-gtk3      |
...
| Plugin             | Fonction                                  | Paquet ou dépôt               |
|--------------------+-------------------------------------------+-------------------------------|
| elpaca             | installation de plugins                   | progfolio/elpaca              |
...
| key-chord          | raccourcis utilisant plusieurs touches    | via elpaca                    |
...
|--------------------+-------------------------------------------+-------------------------------|
| org-mode           | notes, Organisation & Publication         | natif                         |
...
|--------------------+-------------------------------------------+-------------------------------|
| undo-tree          | arbre des annulations                     | via elpaca                    |
|--------------------+-------------------------------------------+-------------------------------|
...
| Plugin            | Fonction                             |
|-------------------+--------------------------------------|
| history cleaner   | garde seulement l’historique récente |
| simple tab groups | groupes d’onglets                    |
| greasemonkey      | scripts js utilisateur               |
...
| aurora store          | alternative à g** play               |
...
| kde connect           | intéraction avec un ordinateur linux |
| orbot                 | tor                                  |
| proton vpn            | vpn proton                           |
|-----------------------+--------------------------------------|
...
| einkBro               | navigateur                           |
| fennec                | navigateur                           |
| monocles browser      | navigateur                           |
| foss browser          | navigateur                           |
|-----------------------+--------------------------------------|
| k9mail                | courriel                             |
...
|-----------------------+--------------------------------------|
| raccoon for friendica | client friendica                     |
|-----------------------+--------------------------------------|
| nomad                 | client hubzilla                      |
|-----------------------+--------------------------------------|
