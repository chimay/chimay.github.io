...
** Forme standard du Ashley book of knot

  1. faire une anse horlogique *H*, partie de travail à droite
  2. faire un demi-tour anti-horlogique vers l’arrière, ce qui forme
     une anse *A* telle que
     - la partie de travail est à droite
     - le bord gauche de *A* est aussi le bord droit de *H*
     - la voûte de *A* est à l’avant
       + tandis que la voûte de *H* est à l’arrière (par défaut)
  3. revenir au niveau de la voûte de *H*
  4. passer dans *H*
     - en entrant sous le bord droit
     - vers la gauche
     - près de la voûte
  5. passer au-dessus du bord gauche de *H*, vers la gauche
  6. tour autour de *H*
     1) passer sous les bords de *H*
	- vers la droite
	- un peu plus en avant
     2) passer au-dessus des bords de *H*, vers la gauche
  7. faire une bobine *B* autour de *H* et de *D*
	...
	- en progressant vers la base de *H*
	- laisser une petite partie de *H* visible, près de la voûte
	  + soit *V* cette partie visible
  8. passer dans *V*
  9. serrer *V* autour de la partie de travail


** Variante simple

Dans sa forme la plus simple, le heaving line est simplement une
