...
| aytdl          | CLI       | Lecteur video sur web                | github/auto-ytdl     |
| ytmdl          | CLI       | Lecteur audio sur web                | pip/ytmdl            |
| you-get        | CLI       | Lecteur video sur web                | you-get              |
| pip-viewer     | CLI       | Client Youtube                       | aur/pipe-viewer      |
| mpsyt          | CLI       | Client Youtube                       | pip/mps-youtube      |
| youtube-curses | TUI       | Client Youtube                       | aur/youtube-curses   |
|----------------+-----------+--------------------------------------+----------------------|
...
|------------+-----------+------------------------------------+-------------------|
| fluidsynth | CLI, SRV  | Synthétiseur midi                  | fluidsynth        |
|            |           | Soundfont pour fluidsynth          | soundfont-fluid   |
|------------+-----------+------------------------------------+-------------------|
