...
| gitup      | CLI       | télécharge src, ports, etc | gitup           |
...
| Commande   | Interface | Fonction          | Paquet ou dépôt |
|------------+-----------+-------------------+-----------------|
| networkmgr | GUI       | gestion du réseau | networkmgr      |
...
| Commande | Interface | Fonction                | Paquet ou dépôt |
|----------+-----------+-------------------------+-----------------|
| sndiod   | SRV       | structure audio & midi  | sndio           |
|          |           | multiplexeur audio      | virtual_oss     |
|          |           |                         | virtual_oss_ctl |
|          |           | serveur séquenceur alsa | alsa-seq-server |
...
| Commande       | Interface | Fonction                | Paquet ou dépôt          |
|----------------+-----------+-------------------------+--------------------------|
| VBoxClient     | LIB       | additions               | virtualbox-ose-additions |
| VBoxClient-all | LIB       | additions               | virtualbox-ose-additions |
...
|----------------------+---------------------------------------|
| kiss launcher        | lanceur d’appplication                |
|----------------------+---------------------------------------|
