...
|-----------------+-----------+----------------------------------------------+------------------------------|
| bspwm           | GUI       | Gestionnaire de fenêtre                      |                              |
...
| wattr           | CLI       | Attributs des fenêtres                       | wmutils                      |
...
| xcape           |           | Pour utiliser un modifier comme autre touche | xcape                        |
|-----------------+-----------+----------------------------------------------+------------------------------|
...
|----------+-----------+----------------------------------+-----------------|
| lf       | TUI       | Gestionnaire de fichiers         | lf              |
...
|----------------+-----------+------------------------------------+------------------------|
| mkdifo         | CLI       | Création de tube (pipe) nommé      | coreutils              |
| socat          | CLI       | Utilitaire pour sockets & pipes    | socat                  |
|----------------+-----------+------------------------------------+------------------------|
