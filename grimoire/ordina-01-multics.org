...
|           | SRV       | language server protocol (lsp) pour bash | bash-language-server |
...
|--------------+-----------+--------------------------------------+----------------------|
| ncspot       | TUI       | client spotify                       | aur/ncspot-bin       |
| spt          | TUI       | client spotify                       | aur/spotify-tui-bin  |
| visp         | TUI       | client spotify                       | aur/visp-spotify-git |
...
| latexmk    | CLI       | compilation de document latex           | texlive-core         |
...
|            |           | paquet supplémentaire pour la science   | texlive-science      |
