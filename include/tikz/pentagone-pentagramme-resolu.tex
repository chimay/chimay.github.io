...
\begin{tikzpicture}[scale=2.0]
	...
	\pic[draw, ->, "$36^\circ$", angle radius=1.4cm, angle eccentricity=1.2]
	{angle = P3--P1--P4};

	\pic[draw, ->, "$72^\circ$", angle radius=0.6cm, angle eccentricity=1.3]
	{angle = P5--G--P1};

	\pic[draw, ->, "$72^\circ$", angle radius=0.6cm, angle eccentricity=1.3]
	{angle = P1--F--P2};

	\pic[draw, ->, "$108^\circ$", angle radius=0.6cm, angle eccentricity=1.3]
	{angle = P5--F--P1};
