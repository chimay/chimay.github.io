...
On dit qu'une fonction $f$ est uniformément continue sur $A$, si pour
toute précision $\epsilon \strictsuperieur 0$, on peut trouver un
$\delta \strictsuperieur 0$ tel que :
...
Le théorème /n'est pas/ applicable aux intervalles ouverts ou semi-ouverts.
