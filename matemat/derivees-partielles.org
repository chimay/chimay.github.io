...
Nous allons à présent voir comment obtenir les composantes de la
différentielle dans le cas d'espaces de dimensions finies.

Soit les espaces vectoriels de dimension finie $\Omega, F$ sur $\corps$
et une fonction $f : \Omega \mapsto F$ différentiable autour d'un point
$a \in \Omega$. Nous disposons donc d'une base $(\varpi_1,...,\varpi_n)$
de $\Omega$ et d'une base $(\phi_1,...,\phi_m)$ de $F$. Nous introduisons
les composantes $f_1,...,f_m : \Omega \mapsto F$ de $f$ telles que :
