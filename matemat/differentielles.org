...
L'idée à la base de la notion de différentielles est de linéariser
localement une fonction $f : \Omega \mapsto F$ autour d'un point $a
\in \Omega$. Pour tout $h \in \Omega$ suffisamment petit, on veut donc
avoir :
...
Dans le cas où $m = n = 1$, il n'y a qu'une dérivée partielle,
$\partial_1 f_1$, que l'on appelle alors dérivée ordinaire. On
peut considérer $\Omega$ et $F$ comme équivalents à $\corps$ et se
restreindre à des fonctions $f : \corps \mapsto \corps$ sans perte de
généralité. La dérivée ordinaire est alors simplement :
