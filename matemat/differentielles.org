...
Pour des fonctions du type $f : \setR^n \mapsto \setR$, la Jacobienne se réduit à un vecteur colonne. On dit alors que $\partial f$ est le gradient de $f$.
