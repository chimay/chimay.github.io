...
Soit un espace fonctionnel $F \subseteq \lebesgue^2(\setR^n,\setR)$ et une
forme $\forme{}{} : F^D \times F \mapsto \setR$ à laquelle on associe
...
Soit un opérateur $L : F \mapsto \lebesgue^2(\setR^n,\setR)$ qui vérifie :
...
$$L : u \mapsto \laplace u = \sum_i \dfdxdx{u}{x_i}$$
