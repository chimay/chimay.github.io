...
L'hypothèse d'indépendance linéaire voudrait que tous les $\alpha_j$
et le $\alpha_i$ soient nuls. Ce qui n'est manifestement pas le cas
puisque $\alpha_i = 1 \ne 0$ !

Aucun des vecteurs de la suite n'est donc combinaison des autres. On
dit qu'aucun vecteur n'est redondant dans la suite.
