...
#+TITLE: Eclats de vers : Matemat : Extrema de polynômes du second degré
#+AUTHOR: chimay
...
Nous avons déjà vu une méthode purement algébrique pour résoudre
l’équation :

$$ a \cdot x^2 + b \cdot x + c = 0 $$

Nous allons à présent voir une autre méthode, centrée sue l’extrémum du
polynôme $p$.
On pose :
...
Expressions qui sont identiques aux solutions obtenues avec la méthode
purement algébrique. On a :
