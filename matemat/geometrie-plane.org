...
Un arc de cercle peut être orienté. Par convention, un arc de cercle à
orientation positive $\Gamma^+$ tourne dans le sens inverse des aiguilles
d’une monte :
...
tandis qu’un arc de cercle $\Gamma^-$ à orientation négative tourne
