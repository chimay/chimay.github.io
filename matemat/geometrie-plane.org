...
L’alignement nous donne une propriété intéressante sur les
distances. On a :
...
Ces deux segments orientés sont donc équivalents. Une autre façon de
déterminer si les sens sont les mêmes est de comparer les distances. On
a :
