...
pour tout $P \in \mathscr{C}\0, r$. Si $\Pi$ est le plan dans lequel le
cercle $\mathscr{C}$ est tracé, on a :
...
Le schéma ci-dessous représenté la droite $t = (AB)$, tangente au
