...
et tels que le segment $[A,B]$ passe par le centre $O$, le diamètre $d$
de $\mathscr{C}$ est la distance entre $A$ et $B$ :
...
Le schéma ci-dessous représenté un arc de cercle $\mathcal{A}$ de centre
$O$ et compris entre les points $A$ et $B$ :
