...
Le schéma ci-dessus donne un exemple de demi-droite :
...
Le schéma ci-dessus donne un exemple de segment :
...
à $B$. Elle est donc égale à la longueur du segment $[A,B]$ :
