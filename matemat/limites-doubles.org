...
Soit un ensemble $F$ et une fonction $f : A \times B \mapsto F$. On
choisit un ensemble $U \subseteq A \times B$. On dit que $L$ est la
limite de $f$ en $(a,b) \in A \times B$ et on le note :
