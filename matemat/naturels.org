...
On a donc $0 \cdot m = m \cdot 0 = 0$. On dit que $0$ est absorbant pour
la multiplication.
...
où le membre de droite compte $n$ termes « $m$ ». Mais comme $m =
m^- + 1$, on a :

$$m \cdot n = m^- + 1 + ... + m^- + 1$$

La commutativité nous permet de regrouper les $n$ nombres $1$ à
la fin :
