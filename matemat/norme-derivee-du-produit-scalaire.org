...
$$\norme{y - \lambda \cdot x}^2 = \scalaire{y - \lambda \cdot x}{x - \lambda \cdot x} $$

Effectuons la double distribution

$$\norme{y - \lambda \cdot x}^2 =
\scalaire{y}{y} - \lambda \cdot \scalaire{y}{x} - \conjaccent{\lambda} \cdot \scalaire{x}{y} + \conjaccent{\lambda} \cdot \lambda \cdot \scalaire{x}{x} \ge 0$$
