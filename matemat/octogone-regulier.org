...
Le triangle $O P_1 P_3$ est rectangle en $O$ car :

$$ \angleflex{P_1 O P_3} = 2 \cdot 45^\circ = 90^\circ $$
...
L’angle au centre du triangle $O P_1 P_4$ a une amplitude de :

$$ \angleflex{P_1 O P_4} = 3 \cdot 45^\circ = 135^\circ $$
