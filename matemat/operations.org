...
On dit qu'un élément $x^\inverse \in \Omega$ est l'inverse de $x \in
\Omega$ pour la loi $\opera$ si :
...
On suppose que $\opera$ admet $n$ comme neutre. Soit $x \in \Omega$
et $y,z \in \Omega$ deux inverses de $x$. On a :
...
Dans le cadre d'une opération associative, l'inverse d'un élément
donné est unique.
