...
On remarque aussi que les triangles $ABC$ et $ABF$ ont des angles
correspondants de même amplitude : ce sont donc des triangles
semblables. Leurs rapports de longueurs sont donc identiques. On a en
particulier :
...
que la solution positive de cette équation définit le nombre d’or :
