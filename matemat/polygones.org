...
Le point $F$ est l’intersection entre le côté $[A,E]$ et le
prolongement du rayon $[O,C]. Les points $F$, $O$ et $C$ sont donc
...
La longueur $L$ du segment $[F,C]$, qui représente aussi la longueur
