...
La somme des angles dans le triangle $HID$ vaut 180° :
...
varient donc pas non plus. On en déduit que :
...
Dans le triangle $AFE$, la loi des cosinus nous donne une expression de
la longueur $c$  :

$$ c = l^2 + a^2 - 2 \ l \ a \ \cos 36^\circ $$

En tenant compte des résultats précédents, cette équation devient :

$$ c^2 = l^2 + l^2 - 2 \ l^2 \ \cos 36^\circ $$

ou encore :

$$ c^2 = 2 \ l^2 - 2 \ l^2 \ \cos 36^\circ $$

Divisons par $l^2$ :

$$ \frac{c^2}{l^2} = 2 - 2 \ \cos 36^\circ $$
