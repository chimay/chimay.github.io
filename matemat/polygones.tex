...
\begin{figure}[htbp]
\centering
\includesvg[width=0.7\linewidth]{tikz/somme-angles-polygone-par-triangles}
\caption{\label{fig:orgf5076f0}polygone à \(n\) côtés divisé en triangles}
\end{figure}
...
\begin{center}
\includesvg[width=0.7\linewidth]{tikz/somme-angles-polygone-par-parcours}
\end{center}
...
\begin{center}
\includesvg[width=0.7\linewidth]{tikz/hexagone-tour-resolu}
\end{center}
...
\begin{center}
\includesvg[width=0.7\linewidth]{tikz/hexagone-diagonales}
\end{center}
...
\begin{center}
\includesvg[width=0.7\linewidth]{tikz/hexagone-diagonales-resolu}
\end{center}
\subsection{Hexagramme}
\label{sec:org97f578d}
...
\begin{center}
\includesvg[width=0.7\linewidth]{tikz/hexagone-hexagramme}
\end{center}
...
\begin{center}
\includesvg[width=0.7\linewidth]{tikz/hexagone-hexagramme-resolu}
\end{center}
\subsection{Nombre d’or}
\label{sec:org3469c0b}

Le schéma ci-dessous représente un hexagone régulier muni de ses
diagonales :

\begin{center}
\includesvg[width=0.7\linewidth]{tikz/hexagone-nombre-d-or}
\end{center}
...
\label{sec:org1795280}

\startcontents[level-1]
\printcontents[level-1]{}{0}{\setcounter{tocdepth}{2}}
\subsection{Angles au centre}
\label{sec:org9a63e36}

Le schéma ci-dessous représente un pentagone régulier inscrit dans un
cercle de centre \(O\) et de rayon \(r\) :

\begin{center}
\includesvg[width=0.7\linewidth]{tikz/pentagone-tour}
\end{center}
...
\begin{center}
\includesvg[width=0.7\linewidth]{tikz/pentagone-tour-resolu}
\end{center}
\subsection{Diagonales}
\label{sec:orgff84886}
...
\begin{center}
\includesvg[width=0.7\linewidth]{tikz/pentagone-diagonales}
\end{center}
...
\begin{center}
\includesvg[width=0.7\linewidth]{tikz/pentagone-pentagramme}
\end{center}
...
\begin{center}
\includesvg[width=0.7\linewidth]{tikz/pentagone-pentagramme-resolu}
\end{center}
\subsection{Invariance sous rotation}
\label{sec:org8c37ada}
...
\begin{center}
\includesvg[width=0.7\linewidth]{tikz/pentagone-invariance-sous-rotation}
\end{center}
...
\begin{center}
\includesvg[width=0.7\linewidth]{tikz/pentagone-nombre-d-or}
\end{center}
...
\label{sec:org2791e2a}

Le schéma ci-dessous représente un pentagone régulier inscrit dans un
cercle de centre \(O\) et de rayon \(r\) :

\begin{center}
\includesvg[width=0.7\linewidth]{tikz/pentagone-rapport-cote-rayon}
\end{center}
...
\label{sec:orge54f3bc}

\startcontents[level-1]
\printcontents[level-1]{}{0}{\setcounter{tocdepth}{2}}
\subsection{Angles au centre}
\label{sec:org063bc1a}

Le schéma ci-dessous représente un octogone régulier inscrit dans un
cercle de centre \(O\) et de rayon \(r\) :

\begin{center}
\includesvg[width=0.7\linewidth]{tikz/octogone-tour}
\end{center}
...
\begin{center}
\includesvg[width=0.7\linewidth]{tikz/octogone-tour-resolu}
\end{center}
\subsection{Diagonales}
\label{sec:orgf3452f6}
...
\begin{center}
\includesvg[width=0.7\linewidth]{tikz/octogone-diagonales}
\end{center}
...
\begin{center}
\includesvg[width=0.7\linewidth]{tikz/octogone-diagonales-resolu}
\end{center}
\subsection{Nombre d’argent}
\label{sec:org8e696d3}

Le schéma ci-dessous représente un octogone régulier muni de certaines
de ses diagonales, ainsi que les diamètres du cercle  :

\begin{center}
\includesvg[width=0.7\linewidth]{tikz/octogone-nombre-d-argent}
\end{center}
