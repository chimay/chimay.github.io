...
Ici, $\corps$ n'est plus un corps mais l'anneau des matrices $X$
de taille $(N,N)$. On dit que $p : \matrice(\corps,N,N) \mapsto
\matrice(\corps,N,N)$ est un polynôme matriciel si il existe $a_0,...,a_n
\in \corps$ tels que :
