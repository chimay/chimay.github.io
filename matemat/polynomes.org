...
$$\mathcal{P}_n = \polynome(\corps,n)$$

* Équivalence avec $\corps^{n+1}$

Tout $n$-tuple $(a_0,a_1,a_2,...,a_n)\in\corps^{n+1}$ peut être associé
à un polynôme :

$$p(x) = \sum_{i = 0}^n a_i \cdot x^i \in \polynome(\corps,n)$$
