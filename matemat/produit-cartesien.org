...
Un n-tuple est une association d’éléments $(x_1,x_2,...,x_n)$ formés
d'éléments des ensembles $A_1, A_2, ..., A_n$. Il s’agit donc d’un
élément du produit cartésien de ces ensembles.
