...
#+TITLE: Eclats de vers : Matemat : Systèmes linéaires
#+AUTHOR: chimay
...
où $A,B,C,D,F,G$ et $x,y$ sont respectivement des matrices et des vecteurs colonnes de tailles compatibles. On a :
...
Utilisant les vecteurs colonnes associés $x = [x_1 \ ... \ x_n]^\dual$ et $y = [y_1 \ ... \ y_m]^\dual$ ainsi que la matrice $A = (a_{ki})_{k,i}$ de taille $(m,n)$, on se retrouve avec le système :
