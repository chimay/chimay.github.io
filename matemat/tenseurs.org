...
Soit les espaces vectoriels $E_1,E_2,...,E_n$ sur $\corps$. On nomme
tenseur d'ordre $n$ les formes $n$-linéaires de $E_1 \times E_2 \times
... \times E_n$ vers $\corps$.
