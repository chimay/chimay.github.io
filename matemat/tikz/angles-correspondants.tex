...
% angles labels %{{{2
	...
	\pic[draw, ->, "$\lambda$", angle radius=0.6cm, angle eccentricity=1.3]
	{angle = Z1--A--X2};

	\pic[draw, ->, "$\mu$", angle radius=0.8cm, angle eccentricity=1.3]
	{angle = Y2--B--Z2};

	\pic[draw, ->, "$\theta$", angle radius=0.8cm, angle eccentricity=1.3]
	{angle = X1--A--Z1};

	\pic[draw, ->, "$\omega$", angle radius=0.6cm, angle eccentricity=1.3]
	{angle = Z2--B--Y1};
