...
% coordinates %{{{1
	...
	\coordinate (O_1) at (-\radius,0);
	\coordinate (O_2) at (0,0);
	\coordinate (O_3) at (\radius,0);
	\coordinate (O_4) at ({-\radius/2},\sqrtradius);
	\coordinate (O_5) at ({\radius/2},\sqrtradius);

	\coordinate (X) at ({-2.5*\radius},0);
...
% circles %{{{1
	...
	\foreach \i in {1,...,5} \draw (O_\i) circle (\radius);
...
% points, dots, vertices labels %{{{1
	...
	\node[below left] at (O_2) {$O_2$};
	\node[below left] at (O_3) {$O_3$};
...
% circles labels %{{{1
	...
	\node at ($ (O_1) + (45:\radius + 0.3) $) {$\mathscr{C}_1$};
	\node at ($ (O_2) + (45:\radius + 0.3) $) {$\mathscr{C}_2$};
	\node at ($ (O_3) + (45:\radius + 0.3) $) {$\mathscr{C}_3$};
	\node at ($ (O_4) + (45:\radius + 0.3) $) {$\mathscr{C}_4$};
