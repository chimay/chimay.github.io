...
% angles labels %{{{1
	...
	\pic[draw, ->, "$120^\circ$", angle radius=1.0cm, angle eccentricity=1.3]
		{angle = P_2--P_1--P_6};

	\pic[draw, ->, "$30^\circ$", angle radius=1.9cm, angle eccentricity=1.2]
		{angle = P_2--P_1--P_3};

	\pic[draw, ->, "$30^\circ$", angle radius=1.9cm, angle eccentricity=1.2]
		{angle = P_5--P_1--P_6};

	\pic[draw, ->, "$60^\circ$", angle radius=2.1cm, angle eccentricity=1.1]
		{angle = P_3--P_1--P_5};
