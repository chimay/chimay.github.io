...
% intersections %{{{1
	...
	\begin{pgfinterruptboundingbox}
		\path[name path=line1] (P_1) -- (P_4);
		\path[name path=line2] (P_3) -- (P_5);
...
% segments, sides, lines labels %{{{1
	...
	\node[below left] at ($ (P_3)!0.5!(P_4) $) {$r$};
	\node[above left] at ($ (P_1)!0.5!(P_3) $) {$r \ \sqrt{3}$};

	\node[above] at ($ (P_3)!0.6!(I) $) {$r \ \sqrt{3} / 2$};
	\node[above] at ($ (P_5)!0.6!(I) $) {$r \ \sqrt{3} / 2$};

	\node[left] at ($ (O)!0.5!(I) $) {$r / 2$};
	\node[left] at ($ (P_4)!0.7!(I) $) {$r / 2$};
...
% segments, sides, lines marks %{{{1
	...
	\tkzMarkSegments[mark=||, size=2pt, pos=0.55](P_3,I)
	\tkzMarkSegments[mark=||, size=2pt, pos=0.65](P_3,I)

	\tkzMarkSegments[mark=||, size=2pt, pos=0.35](I,P_5)
	\tkzMarkSegments[mark=||, size=2pt, pos=0.45](I,P_5)

	\tkzMarkSegments[mark=|, size=2pt, pos=0.45](O,I)
	\tkzMarkSegments[mark=|, size=2pt, pos=0.50](O,I)
	\tkzMarkSegments[mark=|, size=2pt, pos=0.55](O,I)

	\tkzMarkSegments[mark=|, size=2pt, pos=0.65](P_4,I)
	\tkzMarkSegments[mark=|, size=2pt, pos=0.70](P_4,I)
	\tkzMarkSegments[mark=|, size=2pt, pos=0.75](P_4,I)
...
% right angles markers %{{{2
	...
	{right angle = P_5--I--P_1};

	\pic [draw, angle radius=7pt, angle eccentricity=1]
	{right angle = P_4--P_3--P_1};

	\pic [draw, angle radius=7pt, angle eccentricity=1]
	{right angle = P_1--P_5--P_4};
	...
	\pic[draw, ->, "$30^\circ$", angle radius=1.3cm, angle eccentricity=1.3]
	{angle = P_3--P_1--P_4};

	\pic[draw, ->, "$30^\circ$", angle radius=1.4cm, angle eccentricity=1.3]
	{angle = P_4--P_1--P_5};
