...
% segments, sides, lines marks %{{{1
		...
		in {1,...,\numsides}
	{
		...
		\tkzMarkSegments[mark=||, size=2pt, pos=0.4](S_\i,P_\i);
		\tkzMarkSegments[mark=||, size=2pt, pos=0.4](S_\i,P_\j);
	}
...
% angles labels %{{{1
		...
		in {1,...,\numsides}
	{
		\pic[draw, ->, "$60^\circ$", angle radius=0.7cm, angle eccentricity=1.5]
			{angle = P_\j--S_\i--S_\j};
		\pic[draw, ->, "$60^\circ$", angle radius=0.7cm, angle eccentricity=1.5]
			{angle = S_\i--S_\j--P_\j};
	}
	...
	\foreach \i
		...
		in {1,...,\numsides}
	{
		\pic[draw, ->, "$120^\circ$", angle radius=0.7cm, angle eccentricity=1.5]
			{angle = S_\k--S_\j--S_\i};
	}
