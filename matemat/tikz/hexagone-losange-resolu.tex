...
% segments, sides, lines labels %{{{1
	...
	\node[above] at ($ (I)!0.3!(P_2) $) {$r \ \sqrt{3} / 2$};
	\node[above] at ($ (I)!0.3!(P_6) $) {$r \ \sqrt{3} / 2$};

	\node[left] at ($ (I)!0.35!(P_1) $) {$r / 2$};
	\node[left] at ($ (I)!0.35!(O) $) {$r / 2$};
...
% segments, sides, lines marks %{{{1
	...
	\tkzMarkSegments[mark=|, size=2pt, pos=0.25](I,P_2)
	\tkzMarkSegments[mark=|, size=2pt, pos=0.30](I,P_2)
	\tkzMarkSegments[mark=|, size=2pt, pos=0.35](I,P_2)

	\tkzMarkSegments[mark=|, size=2pt, pos=0.25](I,P_6)
	\tkzMarkSegments[mark=|, size=2pt, pos=0.30](I,P_6)
