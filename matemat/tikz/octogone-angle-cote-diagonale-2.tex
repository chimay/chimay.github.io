...
% angles labels %{{{1
	...
	\pic[draw, ->, "$67.5^\circ$" {yshift=6}, angle radius=1.0cm, angle eccentricity=1.5]
		{angle = O--P_3--P_2};

	\pic[draw, ->, "$22.5^\circ$", angle radius=1.7cm, angle eccentricity=1.3]
		{angle = O--P_3--P_8};

	\pic[draw, ->, "$\alpha$", angle radius=2.2cm, angle eccentricity=1.1]
		{angle = P_8--P_3--P_2};
