...
% angles labels %{{{1
	...
	\pic[draw, ->, "$135^\circ$", angle radius=0.9cm, angle eccentricity=1.3]
		{angle = P_2--P_1--P_8};

	\pic[draw, ->, "$45^\circ$", angle radius=1.7cm, angle eccentricity=1.2]
		{angle = P_2--P_1--P_4};

	\pic[draw, ->, "$45^\circ$", angle radius=1.7cm, angle eccentricity=1.2]
		{angle = P_6--P_1--P_8};

	\pic[draw, ->, "$45^\circ$", angle radius=1.9cm, angle eccentricity=1.2]
		{angle = P_4--P_1--P_6};
