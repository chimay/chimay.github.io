...
% segments, sides, lines labels %{{{1
	...
	\node[below right] at ($ (P_1)!0.5!(P_3) $) {$r \ \sqrt{2}$};
	\node[above right] at ($ (P_3)!0.5!(P_5) $) {$r \ \sqrt{2}$};
	\node[above left] at ($ (P_5)!0.5!(P_7) $) {$r \ \sqrt{2}$};
	\node[below left] at ($ (P_7)!0.5!(P_1) $) {$r \ \sqrt{2}$};
...
% segments, sides, lines marks %{{{1
	...
	\tkzMarkSegments[mark=||, size=2pt](P_5,P_7);
	\tkzMarkSegments[mark=||, size=2pt](P_7,P_1);
...
% right angles markers %{{{2
	...
	\foreach \i
		...
		in {1,3,5,7}
	{
		\pic [draw, angle radius=7pt] {right angle = P_\i--P_\j--P_\k};
	}
