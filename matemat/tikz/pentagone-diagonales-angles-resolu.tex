...
% angles labels %{{{1
	...
	\pic[draw, ->, "$108^\circ$", angle radius=1.0cm, angle eccentricity=1.3]
		{angle = P_2--P_1--P_5};

	\pic[draw, ->, "$36^\circ$", angle radius=1.7cm, angle eccentricity=1.2]
		{angle = P_2--P_1--P_3};

	\pic[draw, ->, "$36^\circ$", angle radius=1.7cm, angle eccentricity=1.2]
		{angle = P_4--P_1--P_5};

	\pic[draw, ->, "$36^\circ$", angle radius=1.9cm, angle eccentricity=1.1]
		{angle = P_3--P_1--P_4};
