...
% points, dots, vertices labels %{{{1
	...
	\node[anchor=east] at ($ (O) + (220:0.0) $) {$O$};
...
% segments, sides, lines labels %{{{1
	...
	\node[above left] at ($ (P_2)!0.5!(P_5) $) {$d_1$};
	\node[below left] at ($ (P_2)!0.5!(P_4) $) {$d_2$};
...
% angles labels %{{{1
	...
	\pic[draw, ->, "$108^\circ$", angle radius=0.5cm, angle eccentricity=1.6]
		{angle = P_4--P_3--P_2};
