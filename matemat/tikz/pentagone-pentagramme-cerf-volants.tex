...
% segments, sides, lines labels %{{{1
	...
	\node[above left] at ($ (P_1)!0.65!(S_1) $) {$a_1$};
	\node[below left] at ($ (P_2)!0.65!(S_2) $) {$a_2$};
	\node[below right] at ($ (P_3)!0.65!(S_3) $) {$a_3$};
	\node[above right] at ($ (P_4)!0.65!(S_4) $) {$a_4$};
	\node[above] at ($ (P_5)!0.65!(S_5) $) {$a_5$};

	\node[above right] at ($ (P_1)!0.65!(S_5) $) {$b_1$};
	\node[above] at ($ (P_2)!0.65!(S_1) $) {$b_2$};
	\node[above left] at ($ (P_3)!0.65!(S_2) $) {$b_3$};
	\node[below left] at ($ (P_4)!0.65!(S_3) $) {$b_4$};
	\node[below right] at ($ (P_5)!0.65!(S_4) $) {$b_5$};
