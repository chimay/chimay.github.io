...
% points, dots, vertices labels %{{{1
	...
	\node[below left] at (I_1) {$I_1$};
	\node[below right] at ($ (I_2) + (240:3pt) $) {$I_2$};
	\node[above right] at (I_3) {$I_3$};
	\node[above] at (I_4) {$I_4$};
	\node[above left] at (I_5) {$I_5$};
...
% segments, sides, lines labels %{{{1
	...
	\node[above] at ($ (S_1)!0.5!(I_1) $) {$b_1$};
	\node[left] at ($ (S_2)!0.5!(I_2) $) {$b_2$};
	\node[below left] at ($ (S_3)!0.5!(I_3) $) {$b_3$};
	\node[below right] at ($ (S_4)!0.5!(I_4) $) {$b_4$};
	\node[right] at ($ (S_5)!0.5!(I_5) $) {$b_5$};

	\node[above] at ($ (S_5)!0.5!(I_1) $) {$c_1$};
	\node[left] at ($ (S_1)!0.5!(I_2) $) {$c_2$};
	\node[below left] at ($ (S_2)!0.5!(I_3) $) {$c_3$};
	\node[below right] at ($ (S_3)!0.5!(I_4) $) {$c_4$};
	\node[right] at ($ (S_4)!0.5!(I_5) $) {$c_5$};
