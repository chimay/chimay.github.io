...
% coordinates %{{{1
	...
	%\coordinate (A) at ({\ang/2.2}:{0.7*\gth});
	%\coordinate (B) at (3,2);
	\coordinate (C) at (-1,3);
	...
	\coordinate (SC) at ($ (C) - (S) $);
	\coordinate (CX) at ($ (S) - \ratio*(SC) $);
	\coordinate (CY) at ($ (S) + \fraction*(SC) $);

	%\coordinate (O) at ($(DX)!(A)!(DY)$);
	%\coordinate (P) at ($(FX)!(A)!(FY)$);

	%\coordinate (U) at ($(DX)!(B)!(DY)$);

	\coordinate (V) at ($(FX)!(C)!(FY)$);
...
% segments, sides, lines %{{{1
	...
	\draw[dashdotdotted] (DX) -- (S);
	\draw[dashdotdotted] (FX) -- (S);
...
% points, dots, vertices labels %{{{1
	...
	\node[anchor=south west] at ($ (S) + (1:0.2) $) {$S$};
...
% segments, sides, lines labels %{{{1
	...
	\node[above right] at ($ (FX)!0.9!(FY) $) {$f$};
	%\node[above left] at ($ (AX)!0.9!(AY) $) {$b$};

	\node[left] at ($ (HX)!0.9!(HY) $) {$h$};
	\node[above left] at ($ (LX)!0.9!(LY) $) {$l$};

	\node[below left] at ($ (C)!0.9!(CY) $) {$g$};

	%\node[below] at ($ (DX)!0.3!(S) $) {$a$};
	%\node[below left] at ($ (FX)!0.3!(S) $) {$c$};
