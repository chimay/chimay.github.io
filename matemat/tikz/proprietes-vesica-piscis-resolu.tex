...
% segments, sides, lines labels %{{{1
	...
	\node[below] at ($ (O_1)!0.5!(M) $) {$r/2$};
	\node[below] at ($ (O_2)!0.5!(M) $) {$r/2$};

	\node[right] at ($ (M)!0.2!(I) $) {$r \ \sqrt{3} / 2$};
...
% segments, sides, lines marks %{{{1
	...
	\tkzMarkSegments[mark=|, size=2pt, pos=0.15](M,I)
	\tkzMarkSegments[mark=|, size=2pt, pos=0.20](M,I)
	\tkzMarkSegments[mark=|, size=2pt, pos=0.25](M,I)

	\tkzMarkSegments[mark=|, size=2pt, pos=0.15](M,J)
	\tkzMarkSegments[mark=|, size=2pt, pos=0.20](M,J)
