...
% segments, sides, lines marks %{{{1
	...
	\tkzMarkSegments[mark=|, size=2pt, pos=0.25](M,I)
	\tkzMarkSegments[mark=|, size=2pt, pos=0.30](M,I)
	\tkzMarkSegments[mark=|, size=2pt, pos=0.35](M,I)

	\tkzMarkSegments[mark=|, size=2pt, pos=0.25](M,J)
	\tkzMarkSegments[mark=|, size=2pt, pos=0.30](M,J)
...
% angles labels %{{{1
	...
	\pic[draw, ->, "$30^\circ$", angle radius=1.3cm, angle eccentricity=1.2]
		{angle = I--J--O_1};
