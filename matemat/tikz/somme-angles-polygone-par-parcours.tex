...
\begin{tikzpicture}[scale=0.7]
	...
	\coordinate (A1) at ($ (P1) + \arrowratio*(P1) - \arrowratio*(P6) $);
	\coordinate (A2) at ($ (P2) + \arrowratio*(P2) - \arrowratio*(P1) $);
	\coordinate (A3) at ($ (P3) + \arrowratio*(P3) - \arrowratio*(P2) $);
	\coordinate (A4) at ($ (P4) + \arrowratio*(P4) - \arrowratio*(P3) $);
	\coordinate (A5) at ($ (P5) + \arrowratio*(P5) - \arrowratio*(P4) $);
	\coordinate (A6) at ($ (P6) + \arrowratio*(P6) - \arrowratio*(P5) $);
