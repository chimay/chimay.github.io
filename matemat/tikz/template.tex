...
% operations %{{{3
	...
	%\coordinate (D) at ($ (P) + \len*(AB) $);
	%\coordinate (D) at ($ (P) + \len*(B) - \ratio*(A) $);
...
% reflection of a point across a straight line %{{{3
