...
% parameters %{{{2
	...
	% ---- parameters with indexes
	% ---- does not work

	%\pgfmathsetmacro{\len[1]}{2}
	%\pgfmathsetmacro{\len[2]}{3.5}
	%\pgfmathsetmacro{\len[3]}{1.2}
...
% coordinates %{{{2
	...
	% ---- defined by \pgfmathsetmacro
	% ---- does not work
	%\coordinate (A) at ({len[1]},0);
...
% circular arcs %{{{2
	...
	%\draw (A) ++(-90:\len) arc (-90:90:\len);
	%\draw (B) ++(90:\len) arc (90:270:\len);
