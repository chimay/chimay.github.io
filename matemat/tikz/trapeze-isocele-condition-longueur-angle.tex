...
% segments, sides labels %{{{1
	...
	\node[right] at ($ (D)!0.65!(E) $) {$h_1$};
	\node[left] at ($ (C)!0.35!(F) $) {$h_2$};
...
% segments, sides marks %{{{1
	...
	\tkzMarkSegments[mark=|, size=2pt, pos=0.65](D,E)
	\tkzMarkSegments[mark=|, size=2pt, pos=0.35](C,F)
...
% angles labels %{{{1
	...
	\pic[draw, ->, "$\gamma$", angle radius=0.9cm, angle eccentricity=1.4]
		{angle = E--D--F};
