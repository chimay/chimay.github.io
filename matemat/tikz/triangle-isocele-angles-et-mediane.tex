...
% angles labels %{{{1
	...
	\pic[draw, ->, "$\beta$", angle radius=1.3cm, angle eccentricity=1.2]
	{angle = C--B--D};
	...
	\pic[draw, ->, "$\lambda$", angle radius=1.1cm, angle eccentricity=1.2]
	{angle = A--C--D};

	\pic[draw, ->, "$\mu$", angle radius=1.1cm, angle eccentricity=1.2]
	{angle = D--C--B};
