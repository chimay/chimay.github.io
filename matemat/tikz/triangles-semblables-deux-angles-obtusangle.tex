...
% segments, sides, lines labels %{{{1
	...
	\node[below right] at ($ (A)!0.75!(C) $) {$b$};

	\node[left] at ($ (A)!0.7!(F) $) {$f$};

	\node[below] at ($ (B)!0.6!(C) $) {$u$};
	\node[below] at ($ (C)!0.5!(F) $) {$v$};

	\node[below] at ($ (D)!0.5!(E) $) {$w$};
	\node[below] at ($ (E)!0.5!(G) $) {$z$};
...
% angles labels %{{{1
	...
	\pic[draw, ->, "$\alpha$", angle radius=1.6cm, angle eccentricity=1.3]
	{angle = B--A--C};
