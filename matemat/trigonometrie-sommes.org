...
[[file:tikz/trigo-somme-angles.svg]]
...
$$ \sin\Big[(\alpha + \beta)/2\Big] = \cos(\gamma/2) $$

et vice versa :

$$ \cos\Big[(\alpha + \beta)/2\Big] = \sin(\gamma/2) $$
...
$$ \frac{a + b}{c}
= \frac{2 \ \sin\Big[(\alpha + \beta)/2\Big] \ \cos\Big[(\alpha - \beta)/2\Big]}{2 \ \sin(\gamma/2) \ \cos(\gamma/2)} $$

En se rappelant les relations de complémentarité entre $(\alpha + \beta)/2$
et $\gamma/2$, il vient :

$$ \frac{a + b}{c}
= \frac{2 \ \cos(\gamma/2) \ \cos\Big[(\alpha - \beta)/2\Big]}{2 \ \sin(\gamma/2) \ \cos(\gamma/2)} $$
...
La complémentarité nous permet d’écrire une variante de cette relation :
...
$$ \frac{a - b}{c}
= \frac{2 \ \sin\Big[(\alpha - \beta)/2\Big] \ \sin(\gamma/2)}{2 \ \sin(\gamma/2) \ \cos(\gamma/2)} $$
...
= \frac{\sin\Big[(\alpha - \beta)/2\Big]}{\sin\Big[(\alpha + \beta)/2\Big]} \cdot
\frac{\cos\Big[(\alpha + \beta)/2\Big]}{\cos\Big[(\alpha - \beta)/2\Big]} $$

que l’on peut réécrire :

$$ \frac{a - b}{a + b}
= \frac{\sin\Big[(\alpha - \beta)/2\Big]}{\cos\Big[(\alpha - \beta)/2\Big]} \cdot
\frac{\cos\Big[(\alpha + \beta)/2\Big]}{\sin\Big[(\alpha + \beta)/2\Big]} $$

ou encore :

$$ \frac{a - b}{a + b}
= \tan\Big[(\alpha - \beta)/2\Big] \cdot \unsur{\tan\Big[(\alpha + \beta)/2\Big]} $$
