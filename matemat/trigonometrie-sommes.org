...
$$ c
= h \ \tan\alpha + h \ \tan\beta
= h \ (\tan\alpha + \tan\beta) $$

$$ \frac{c}{\sin(\alpha + \beta)} = \frac{a}{\sin\gamma} $$

$$ \gamma = 90^\circ - \alpha $$

$$ \sin\gamma = \cos\alpha $$

$$ \frac{c}{\sin(\alpha + \beta)} = \frac{a}{\cos\alpha} $$

$$ \cos\beta = \frac{h}{a} $$

$$ a = \frac{h}{\cos\beta} $$

$$ \frac{h \ (\tan\alpha + \tan\beta)}{\sin(\alpha + \beta)} = \frac{h}{\cos\alpha \ \cos\beta} $$

$$ \frac{\tan\alpha + \tan\beta}{\sin(\alpha + \beta)} = \frac{1}{\cos\alpha \ \cos\beta} $$
