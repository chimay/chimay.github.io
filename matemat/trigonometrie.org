...
En utilisant les degrés, ces résultats s’écrivent :

$$ \cos(\alpha+90^\circ) = - \sin\alpha $$

$$ \sin(\alpha+90^\circ) = \cos\alpha $$

$$ \tan(\alpha+90^\circ) = \frac{-1}{\tan\alpha} $$
...
$$ \sin(\alpha+270^\circ) = - \cos\alpha $$

$$ \tan(\alpha+270^\circ) = \frac{-1}{\tan\alpha} $$
...
On considère qu’ajouter un nombre entier $k \in \setZ$ de tours
complets (multiple entier de $2\pi$) ne change rien aux fonctions
trigonométriques. On a donc :

$$ \cos(\alpha + 2 \ \pi \ k) = \cos \alpha $$

$$ \sin(\alpha + 2 \ \pi \ k) = \sin \alpha $$

Le choix $n = -k$ nous donne :

$$ \cos(\alpha - 2 \ \pi \ n) = \cos \alpha $$

$$ \sin(\alpha - 2 \ \pi \ n) = \sin \alpha $$

Ce postulat permet de couvrir l’ensemble des angles à amplitude réelle.
...
Soit un triangle quelconque $ABC$ et son cercle circonscrit $\mathscr{C}$
de centre $O$ et de rayon $r$ :

#+attr_html: :width 32%
#+attr_latex: :width 0.7\linewidth
[[file:tikz/loi-des-sinus-etendue.svg]]

Comme $\delta$ est un angle au centre qui intercepte le même arc de
cercle que l’angle $\alpha$, on a :

$$ \delta = 2 \ \alpha
\qquad \Longleftrightarrow \qquad
\alpha = \frac{\delta}{2} $$

Notons $M$ le point milieu du côté $[B,C]$ et traçons la médiane
$[O,M]$ du triangle $OBC$. Comme ce triangle est isocèle en $O$, cette
médiane est aussi une hauteur et une bissectrice. L’angle $\delta$
se trouve donc divisé en deux angles $\alpha$ de même amplitude,
et notre schéma devient :

#+attr_html: :width 32%
#+attr_latex: :width 0.7\linewidth
[[file:tikz/loi-des-sinus-etendue-mediane.svg]]

Dans le triangle rectangle $OMC$, on a :

$$ \sin\alpha = \frac{a/2}{r} = \frac{a}{2 \ r} $$
...
On a donc finalement la loi des sinus étendue :
...
des deux autres côtés, de laquelle on enlève le double du produit
...
Soit un triangle $ABC$ et sa hauteur $h$ :

#+attr_html: :width 40%
#+attr_latex: :width 0.7\linewidth
[[file:tikz/aire-triangle-par-sinus.svg]]
...
L’aire $\mathcal{A}$ du triangle $ABC$ vaut :

$$ \mathcal{A} = \frac{c \ h}{2} $$

En remplaçant la hauteur $h$ par son expression, on obtient :

$$ \mathcal{A} = \frac{b \ c \ \sin\alpha}{2} $$

On peut montrer par un raisonnement similaire que :

$$ \mathcal{A} = \frac{a \ b \ \sin\gamma}{2}
\qquad \qquad \qquad
\mathcal{A} = \frac{a \ c \ \sin\beta}{2} $$

L’aire d’un triangle est égale à la moitié du produit de deux de
ses côtés multipliés par le sinus de l’angle qu’ils forment.

** Rayon du cercle circonscrit

Soit le triangle $ABC$ et son cercle circonscrit $\mathscr{C}$ de rayon
$r$ :

#+attr_html: :width 32%
#+attr_latex: :width 0.7\linewidth
[[file:tikz/aire-triangle-par-sinus-rayon.svg]]

L’aire de ce triangle vaut par exemple :

$$ \mathcal{A} = \frac{b \ c \ \sin\alpha}{2} $$

La loi des sinus étendue nous donne aussi :

$$ \frac{a}{\sin\alpha} = 2 \ r $$

Isolons le sinus de $\alpha$ :

$$ \sin\alpha = \frac{a}{2 \ r} $$

En remplaçant cette valeur dans l’expression de l’aire, on obtient :

$$ \mathcal{A} = \frac{a \ b \ c}{4 \ r} $$
