...
dont l’hypothénuse vaut $1$ pour chaque angle $\theta$. La figure
ci-dessus en illustre un exemple. Les deux autres côtés sont alors de
longueurs :

$$ a = 1 \cdot \cos \theta = \cos \theta $$

$$ b = 1 \cdot \sin \theta = \sin \theta $$
...
** Généralisation pour n’importe quel angle réel

On généralise à n’importe quel angle réel en considérant qu’ajouter
un nombre entier de tours complets (multiple entier de $2\pi$) ne change
rien aux fonctions trigonométriques. On a donc :
