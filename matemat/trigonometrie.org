...
$$ \frac{z}{x} = \frac{\varphi \ c}{\varphi \ a} = \frac{c}{a} $$

ainsi que pour le rapport entre la seconde cathète et l’hypothénuse :

$$ \frac{z}{y} = \frac{\varphi \ c}{\varphi \ b} = \frac{c}{b} $$
...
qui nous incite à définir ces rapports comme des fonctions de cet angle.
...
$$ c^2 = a^2 \ (\sin \gamma)^2 + (b - a \ \cos \gamma)^2 $$

Appliquons la formule de distribution du carré parfait :

$$ c^2 = a^2 \ (\sin \gamma)^2 + b^2 - 2 \ a \ b \ \cos \gamma + a^2 \ (\cos \gamma)^2 $$

et mettons $a^2$ en évidence :

$$ c^2 = a^2 \left[(\sin \gamma)^2 + (\cos \gamma)^2 \right] + b^2 - 2 \ \ a \ b \cos \gamma $$
...
Dans le triangle rectangle $CDA$, nous avons :
...
$$ c^2 = a^2 \ (\sin \theta)^2 + (b + a \ \cos \theta)^2 $$

Appliquons la formule de distribution du carré parfait :

$$ c^2 = a^2 \ (\sin \theta)^2 + b^2 + 2 \ a \ b \ \cos \theta + a^2 \ (\cos \theta)^2 $$

et mettons $a^2$ en évidence :

$$ c^2 = a^2 \left[(\sin \theta)^2 + (\cos \theta)^2 \right] + b^2 + 2 \ \ a \ b \cos \theta $$
...
Comme $\theta$ et $\gamma$ forment ensemble un angle plat on a :
...
$$ \cos \theta = \cos(\pi - \gamma) = - \cos \gamma $$

En tenant compte de cette identité, la relation pour $c^2$ devient :
