...
** Rêve lucide                                                     :noexport:

Il s’agit d’un rêve où l’on prend conscience d’être dans un rêve.

Avertissement : le rêve lucide n’est pas sans risque, aux dires de
certains praticiens. Pour cette raison, j’hésite à rendre ce chapitre
public. Si vous souhaitez malgré tout expérimenter, une extrême
prudence est recommandée.

Deux méthodes

  1) prendre conscience de rêver pendant le rêve
  2) rester conscient pendant la transition vers le sommeil

Espace vide

  - espace dans le mental où se forme les rêves
  - connecté à la conscience collective
  - connection vers le soi véritable
  - carrefour vers de nombreuses possibilités

Position

  - les jambes, au choix
    + les pieds se touchent
    + un pied touche le genou opposé
  - les bras, au choix
    + les bras se croisent sur la poitrine
    + les bras sont placés le long du corps
  - le dos est contre le matelas
  - la tête se tourne vers la droite
    + idéalement, l’oreille droite est complètement recouverte par l’oreiller

Préparation

  - prendre l’habitude de se rappeler de ses rêves au réveil
    + noter ses rêves au réveil, avant que ses souvenirs ne s’évaporent
    + entraîne l’inconscient à faire attention aux rêves
  - se poser régulièrement la question de savoir si on est réveillé
  - méditations : contrôler pensées & émotions
    1. visualisation
       - s’entraîner à visualiser des objets
       - imaginer les détails
    2. silence
       - essayer de retracer l’origine de chaque pensée
       - examiner ses pensées comme vu depuis l’extérieur
       - se demander quelles pensées proviennent
         + réellement de vous
         + d’une influence extérieure
   	 + de la société
   	 + de choses superficielles, vues ou entendues
       - variante : mode observation
         + essayer de garder les yeux ouverts sans cligner le plus
           longtemps possible
    3. calme du corps
       - s’installer confortablement
       - ne pas attendre de se sentir fatigué
       - rester sans bouger
         + de plus en plus longtemps
         + jusqu’à atteindre au moins 1 heure
       - ne pas s’endormir
       - au bout d’un moment, on se sent engourdi
       - prélude
         + à la transition dans l’espace vide
         + à une éventuelle projection astrale
...
Voir la section [[file:bienetre-04-yoga.org::#heading:respiration][respiration]] dans le fichier yoga.


** Techniques taoïstes

Voir la section [[file:bienetre-05-qigong.org::#heading:respiration][respiration]] dans le fichier Qi Gong.
...
Les techniques ci-dessous permettent de favoriser la relaxation du
corps et de l’esprit, ainsi que la plongée dans la conscience. L’idée
est de piocher ce qui vous convient pour forger votre propre méthode
de méditation.
...
*** Respiration
  ...
  - commencer par prendre quelques grandes respirations profondes si
    nécessaire, pour se détendre
...
Cherche le son qui habite le silence, et le silence caché derrière ce
son.
...
On laisse le silence s’installer progressivement.
  ...
  - les pensées peuvent aussi provenir de derrière soi
    + si le regard se tourne vers l’avant, porter aussi son attention
      tout autour du crâne
...
Répéter mentalement un mantra en boucle peut aider l’esprit à ne pas
se laisser emporter par toutes sortes de pensées. Le son :
...
*** Pleine conscience
  ...
  - écouter, sans se laisser emporter
    + les pensées
    + les émotions
  - l’attention part du centre, s’étend vers l’intérieur puis vers
    l’extérieur
...
*** Relâcher
  ...
  - laisser l’esprit flotter librement à travers les cloisons des
    constructions mentales
    + ces constructions présentent bien sûr un intérêt créatif ou
      conceptuel, mais pendant la méditation on ne se focalise pas sur
...
Voir la section [[file:bienetre-04-yoga.org::#heading:mudras][mudras]] dans le fichier yoga.
...
** Pratique
:PROPERTIES:
:CUSTOM_ID: heading:chantPratique
:END:
...
Voir la section [[file:bienetre-04-yoga.org::#heading:mantras][mantras]] dans le fichier yoga.
...
* Exercice physique
:PROPERTIES:
:CUSTOM_ID: heading:exercicePhysique
:END:
...
Les bienfaits sont plus sensibles lorsque l’exercice physique
...
En cas de chaleur, on perd plus de sels minéraux avec la
transpiration. Dans ce cas, penser à compenser en consommant un peu
plus d’aliments qui en contiennent.
...
** Souplesse
  ...
  - essayer d’être le plus fluide, le plus souple possible dans ses
    gestes
  - un bon indicateur : faible bruit, pas de chocs
    + marcher sans choc ressenti dans le corps, en faisant le moins de
      bruit possible
